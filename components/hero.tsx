              ...
              <div className="flex flex-wrap gap-1.5">
                {categories.map((cat) => (
                  <Link
                    key={cat.categorie}
                    href={`/${cat.categorie}`}
                    className="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg text-xs font-medium bg-white border border-gray-200 text-gray-600 hover:border-blue-400 hover:text-blue-600 transition shadow-xs"
                  >
                    {cat.categorie_label}
