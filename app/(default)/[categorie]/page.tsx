      ...
      <section className="relative overflow-hidden">
        ...
        <div className="max-w-screen-2xl mx-auto px-6 sm:px-8">
          <div className="pt-28 pb-8 md:pt-36 md:pb-12">
            <div className="mb-3">
              <Link className="text-indigo-500 font-medium hover:underline text-sm" href="/">
                ← Tous les marchés
              </Link>
            </div>
            <h1 className="h1 font-inter mb-4">
              Appels d'offre{' '}
              <span className="font-nycd text-indigo-500 font-normal">{label}</span>
            </h1>
              ...
              <div className="flex flex-wrap gap-2">
                {regions.slice(0, 12).map((r) => (
                  <Link
                    ...
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-sm font-medium bg-white border border-gray-200 text-gray-700 hover:border-indigo-400 hover:text-indigo-600 transition shadow-xs"
                  >
                    {r.region_label}
              ...
              <div className="md:grow">
                <div className="pb-8 md:pb-16">
                  <div className="flex items-baseline justify-between mb-8">
                    <h2 className="text-2xl font-bold font-inter">Marchés — {label}</h2>
                    {count > 0 && (
                  ...
                  <div className="flex flex-col">
                    {appelsOffre.length === 0 ? (
                      <div className="py-16 text-center text-gray-400">
                        ...
                        <Link className="text-indigo-500 hover:underline" href="/">Voir tous les marchés</Link>
                      </div>
                    ) : (
